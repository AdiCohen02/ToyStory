...
//import de.uni_luebeck.itm.soundofthecity.api.Logging;
//import de.uni_luebeck.itm.soundofthecity.api.SoundOfTheCityConstants;
//import de.uni_luebeck.itm.soundofthecity.exceptions.NoValidNoiseLevelException;

public class avgSoundLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopplayTV.setBackgroundColor(getResources().getColor(R.color.white));
    ...
    private void RequestPermissions() {
        ...
        ActivityCompat.requestPermissions(avgSoundLevel.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }
